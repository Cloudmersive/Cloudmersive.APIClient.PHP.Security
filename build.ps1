...
& java -jar swagger-codegen-cli.jar generate -i https://api.cloudmersive.com/swagger/api/security -l php -c packageconfig.json
#(Get-Content ./client/package.json).replace('v1', '1.0.1') | Set-Content ./client/package.json
Copy-Item ./cloudmersive_security_api_client/* -Destination . -Recurse -Force
...
(Get-Content ./README.md).replace('This PHP package is automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project:', '[Cloudmersive Security API](https://www.cloudmersive.com/security-threat-detection-api) helps you detect and block security threats.') | Set-Content ./README.md
